...
<script src="{{ asset('backend/js/switch.min.js') }}"></script>
<script src="{{ asset('backend/js/datatables.min.js') }}"></script>
<script src="{{ asset('backend/js/sweet_alert.min.js') }}"></script>
<script src="{{ asset('backend/js/select2.min.js') }}"></script>
<script src="{{ asset('backend/js/uniform.min.js') }}"></script>
<script src="{{ asset('backend/js/bootstrap_multiselect.js') }}"></script>
...
<script src="{{ asset('backend/js/vfs_fonts.min.js') }}"></script>
<script src="{{ asset('backend/js/buttons.min.js') }}"></script>
<script src="{{ asset('backend/js/jgrowl.min.js') }}"></script>
