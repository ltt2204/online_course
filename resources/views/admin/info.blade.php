            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    ...
                    <div id="colored-justified-tab1" class="tab-pane fade show active">
                        <div class="card-body">
                            <form action="{{ route('user.store-info') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('POST')
                    ...
                    <div id="colored-justified-tab2" class="tab-pane fade">
                        <div class="card-body">
                            <form action="{{ route('user.store-password') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('POST')
                    ...
                    <div id="colored-justified-tab3" class="tab-pane fade">
                        <div class="card-body">
                            <form action="{{ route('user.store-avatar') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('POST')
