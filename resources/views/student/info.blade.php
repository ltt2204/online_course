            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    ...
                    <div id="colored-justified-tab1" class="tab-pane fade show active">
                        <div class="card-body">
                            <form action="{{ route('student.store-info') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('POST')
                    ...
                    <div id="colored-justified-tab2" class="tab-pane fade">
                        <div class="card-body">
                            <form action="{{ route('student.store-password') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('POST')
                    ...
                    <div id="colored-justified-tab3" class="tab-pane fade">
                        <div class="card-body">
                            <form action="{{ route('student.store-avatar') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('POST')
