    ...
    <div class="col-xl-6 mx-auto">
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title text-blue-700">Sửa môn học</h5>
            ...
            <div class="card-body">
                <form action="{{ route('course.update', ['id' => $course->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="key" class="form-control" value="{{ old('key', $course->key) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="content" class="form-control" value="{{ old('content', $course->content) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            ...
                            value="{{ old('avatar', $course->avatar) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="checkbox" name="status" class="form-check-input form-check-input-switch" 
                                data-on-text="Hoạt động" data-off-text="Tạm dừng" {{ (old('status', $course->status) == 'on') ? 'checked' : '' }}>
                        </div>
                    </div>

                    @include('common.button',['exit' => 'course.index'])
