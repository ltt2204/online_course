...
class StudentController extends Controller
{
    ...
    public function storeInfo(Request $request)
    {
        ...
        return redirect()->route('student.info')->with('success', 'Thay đổi thông tin thành viên thành công');
    }
    ...
    public function storeAvatar(Request $request)
    {
        ...
        return redirect()->route('student.info')->with('success', 'Thay đổi thành công ảnh đại diện của thành viên.');
    }
    ...
    public function storePassword(Request $request)
    {
        ...
        return redirect()->route('student.info')->with('success', 'Mật khẩu của bạn đã thay đổi thành công.');
    }
